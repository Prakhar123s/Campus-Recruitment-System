                ...
                <%  
                                                ...
                                                try 
                                              {
                                                  Class.forName("com.mysql.jdbc.Driver");
                                                      ...
                                                      System.err.println("enrollment from coordinator page:" + enrollment);

                                                  
                                                      String query = "Select * from studentpllacementdtls where enrollment= '" + enrollment + "'";
		...
		<form action="#">
			<div class="user_details">				
				...
				<div class="input-box">
					...
					<span style="font-weight: 700"><%=rs.getString(4)%></span>
				...
				<div class="input-box">
					...
					<!-- <input type="textarea" required> -->
                                                                                                  ...
                                                                                                  <div class="input-box">
					<span class="details">Course Enrolled</span>
					<span style="font-weight: 700"><%=rs.getString(8)%></span>
					<!-- <input type="textarea" required> -->
				</div><div class="input-box">
					<span class="details">Nam Of Insitute</span>
					<span style="font-weight: 700"><%=rs.getString(9)%></span>
					<!-- <input type="textarea" required> -->
				</div>
